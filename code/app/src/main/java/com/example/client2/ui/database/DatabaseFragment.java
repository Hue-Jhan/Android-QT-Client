...
/**
 * Fragment per la gestione delle operazioni sui dati presenti nel database.
 * <p>
 * Questo fragment consente all'utente di:
 * <ul>
 *     <li>Caricare una tabella dal database remoto.</li>
 *     <li>Calcolare i cluster tramite algoritmo di clustering (QTMiner lato server).</li>
 *     <li>Salvare i cluster calcolati in un file.</li>
 * </ul>
 *
 * <p>
 ...
 *
 * <p>
 * Il fragment utilizza ViewBinding ({@link FragmentDatabaseBinding}) per accedere
 * ai componenti grafici e aggiorna la UI dal thread principale tramite
 * {@link androidx.fragment.app.Fragment#requireActivity()} e {@link Runnable}.
 * </p>
 */
public class DatabaseFragment extends Fragment {
     ...
     * <ul>
     *     <li><b>Carica tabella</b>: invia il nome della tabella al server e mostra i dati ricevuti.</li>
     *     <li><b>Invia raggio</b>: invia un valore di raggio al server per calcolare i cluster.</li>
     *     <li><b>Salva cluster</b>: salva i cluster calcolati in un file sul server.</li>
     * </ul>
     *
     * <p>
     * Se l'app non è connessa a un server (verifica con {@link MainActivity#isConnectedToServer()}),
     * viene mostrato un messaggio e il fragment non viene caricato.
     * </p>
     *
